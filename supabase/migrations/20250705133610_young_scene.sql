/*
  ...
  1. New Tables
    - `posts` - Main posts table with rich content support
    - `saved_posts` - User bookmarks/saved posts
...
DROP FUNCTION IF EXISTS update_user_post_count_on_posts();
...
DROP TRIGGER IF EXISTS update_user_post_count_on_posts_trigger ON posts;
...
GRANT EXECUTE ON FUNCTION update_post_like_count() TO service_role;
GRANT EXECUTE ON FUNCTION update_post_comment_count() TO service_role;
GRANT EXECUTE ON FUNCTION update_user_post_count_on_posts() TO service_role;
